...
while True:
    user = api.get_user('JOSEABR74562814')
    api.update_profile(name=f'jose|{follower_count(user)} Followers')
    print(f'Updating Twitter Name :jose|{follower_count(user)} Followers')
